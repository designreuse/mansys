...
<iframe name="content" class="ui-layout-center" src="<c:url value='/welcome'/>" frameborder="0" scrolling="auto"></iframe>
<div class="ui-layout-north" style="text-align: right">欢迎[<shiro:principal/>]，<a href="${pageContext.request.contextPath}/logout">退出</a></div>
